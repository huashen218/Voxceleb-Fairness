...
print(f"len(speakers_f) = {len(speakers_f)}, len(speakers_m) = {len(speakers_m)}")
...
def get_all_pairs(all_positive_trials, all_negative_trials, speakers_g1, num_trials):
...
if "_f" in dataset:
    all_positive_trials, all_negative_trials = get_all_pairs(all_positive_trials, all_negative_trials, speakers_f, num_trials)

elif "_m" in dataset:
    all_positive_trials, all_negative_trials = get_all_pairs(all_positive_trials, all_negative_trials, speakers_m, num_trials)
