...
parser.add_argument('--train_list',      type=str,   default="/home/ubuntu/MLData/work/Repos/voxceleb_trainer/data/train_list_f4m1.txt",   help='Online Evaluation list');
parser.add_argument('--train_list_m',      type=str,   default="/home/ubuntu/MLData/work/Repos/voxceleb_trainer/data/train_list_f4m1_m.txt",   help='Evaluation list');
parser.add_argument('--train_list_f',      type=str,   default="/home/ubuntu/MLData/work/Repos/voxceleb_trainer/data/train_list_f4m1_f.txt",   help='Evaluation list');
...
def generate_gender_list(args, m_ID_list, f_ID_list):
    ...
    out_m = open(args.train_list_m, "w")
    out_f = open(args.train_list_f, "w")
